...
<div className="ant-layout-sider-children">
        <div className="brand">
            <div className="logo">
                <img alt="logo" src="/logo.png" style={{ width: "80px", height: "80px"}}/>
                <a href='/'><h1>Cloud Storage</h1>
				</a>
            </div>
        </div>
								...
								<div style={{ margin: "10px" }} onClick={() => {
									...
									<Upload {...{
										...
										beforeUpload: (file, fileList) => {
											...
											hide = message.loading('Uploading..', 3)
...
<header className='header'>
					{/* search and config */}
						<TextField className='searchfield' label="Search" type="search" variant="outlined"
							InputProps={{
								endAdornment: (
						...
						<IconButton onClick={() =>
							...
							style={{ marginTop: "0px", marginRight: "25px" }}
						>
							<SettingsIcon className="icons" />
						</IconButton>

</header>
<container className="container" id='containerBody'>

                   {/* folders */}
				   {this.state.folders.length > 0  ? <Typography variant="h3" style={{ display: "flex", margin: " 0 5%", opacity: "0.2" }}>Dossiers</Typography> : ""}
...
{this.state.folders.length > 0 && (this.state.notes.length > 0 || this.state.files.length > 0) ? (<><br/> <Divider style={{ width: "63%", opacity: "0.6", margin: "0 auto" }} /></>): ""}
<br/> <br/>
{this.state.notes.length > 0 || this.state.files.length > 0 ? <Typography variant="h4" style={{ display: "flex", margin: " 0 5%", opacity: "0.3" }}>Fichiers</Typography> : ""}
								...
								<div className="files" key={item._id}>
									...
									>
										{item.type.startsWith('image') ? 
											<img width="210" height="210" src={(this.state.previewImg.length-1 >= idx && this.state.previewImg[idx] !== null) ? this.state.previewImg[idx] : ""} alt={"img"} /> 
											:
...
<footer className="globalFooter footer">
        <div className="copyright">NOSQL MINIPROJET ©2022 estm</div>
    </footer>
</main>
				</div>
				<style>{`
				...
				#containerBody{height: 100vh;padding: 0 75px;}
